                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @foreach (Auth::user()->notifications->take(5) as $notification)
                                    <a class="dropdown-item d-flex align-items-center {{ $notification->read_at ? '' : 'bg-gray-200' }}"
                                        href="{{ $notification->data['url']}}?id={{ $notification->id}} ">
                                        ...
                                        <div>
                                            ...
                                            <span class="font-weight-bold ">{{ $notification->data['msg'] }}</span>
                                        </div>
                                ...
                                <a class="dropdown-item text-center small text-gray-500"
                                    href="{{ route('admin.notifications') }}">Show All Alerts</a>
                            </div>
                        </li>
